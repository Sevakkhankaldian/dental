...
SELECT set_config('app.organization_id', '01989a50-0000-7000-8000-000000000001', true);
...
VALUES
  ...
  (
    '01989a50-0000-7000-8000-000000001003',
    'PATIENT',
    'fa-IR',
    'ACTIVE'
  )
...
UPDATE users
SET normalized_phone_hash = encode(
  hmac('+989000000001', 'local-only-phone-pepper-change-me', 'sha256'),
  'hex'
)
WHERE id = '01989a50-0000-7000-8000-000000001003';
...
VALUES
  ...
  ('01989a50-0000-7000-8000-000000002003', '01989a50-0000-7000-8000-000000000001', '01989a50-0000-7000-8000-000000000101', '01989a50-0000-7000-8000-000000001003', 'PATIENT', 'ACTIVE', '2026-08-12T00:00:00Z')
ON CONFLICT (id) DO NOTHING;
